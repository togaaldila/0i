...
![img7.png](img7.png)
8. Klik Start Simulation untuk memulai simulasi. Klik potensiometer dan ubah dari posisi awal. Klik pada Serial Monitor, maka akan menampilkan nilai PWM sesuai posisi (nilai) potensiometer.
![img8.png](img8.png)
