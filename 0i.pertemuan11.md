![image](https://github.com/user-attachments/assets/29992412-0b38-4aae-bd16-bd151dd63ebf)# Pertemuan ke 11 : Praktik Pemrograman Microcontroller

## Topik Bahasan
Proyek Dasar Internet of Things I (Praktik Pemrograman Mikrokontroler NodeMCU ESP8266, Praktik Sensor: Sensor DHT11, LCD dan Kipas, Praktik Sensor: Ultrasonic, PIR, dan LDR, Praktik Aktuator: LED dan Relay, Praktik Aktuator: Buzzer dan Servo)

## Deskripsi
• Mahasiswa mampu melakukan instalasi Memahami bahasa pemrograman dan pin pada Arduino. Mampu melakukan uji coba serial monitor dan uji coba PWM dengan potensiometer.
