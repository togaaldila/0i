...
+ Duplikasi code berikut
```python
#Untuk membuat pin PWM, impor class PWM selain class Pin dari modul machine.
from machine import Pin, PWM 
from time import sleep

frequency = 5000
#buat objek PWM yaitu led.
led = PWM(Pin(5), frequency) 

#Di dalam perulangan while, kita membuat perulangan for yang meningkatkan siklus kerja sebesar 1 di setiap perulangan dengan interval 5 ms di antara setiap perubahan.
while True:
  for duty_cycle in range(0, 1024):
    #Untuk mengatur siklus kerja gunakan metode duty() pada objek PWM dan teruskan siklus tugas sebagai argumen:
    led.duty(duty_cycle)
    sleep(0.005)
```
+ Hasilnya seharusnya led berganti tingkat terangnya.
  <iframe width="791" height="494" src="[https://www.youtube.com/embed/Kl3SKNt_dmY?list=PLwf0IXJ0LAVg_NkeZL_KydrtrNGM1MfMp](https://youtu.be/FfVE_UA46E)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
